 ...
 *  Data: 31 maja 2017 r.
 */
public class MenuGlowne extends WypozyczalniaAplikacja {
    ...
    private void sprzedawcaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sprzedawcaButtonActionPerformed
        sprzedawcaMenu = new MenuSprzedawca();
    ...
    private void wrocButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_wrocButtonActionPerformed
        try {
            wypozyczalnia.zapiszDoPliku(DATA_FILE_NAME);
            UI.printMessage("\nKonta, filmy i calkowity utarg zostaly zapisane do pliku " + DATA_FILE_NAME);
        }
        catch (Exception e) {
